...
function keyPressed() {
    if (!gameOver && !gameWon) {
        switch (keyCode) {
            case 49://when pressing 1 as LEFT_ARROW:
                horizontalSlide(LEFT_ARROW);
                updateGrid();
                break;
            case 50://when pressing 2 as RIGHT_ARROW:
                horizontalSlide(RIGHT_ARROW);
                updateGrid();
                break;   
            case 51:// when pressing key 3 as UP_ARROW:
                verticalSlide(UP_ARROW);
                updateGrid();
                break;
            case 52 :// when pressing 4 as DOWN_ARROW:
